      ...
      {showCapture ? (
        <section className="bb-closer">
          <div className="bb-closer-card">
            <p className="bb-eyebrow">Your city, this fall</p>
            <h2 className="bb-closer-title">Meet you there.</h2>
            <p className="bb-closer-sub">
              We&rsquo;ll let you know when Bubba
              <br />
              arrives in your city.
            </p>
            <BubbaCapture label="Join the waitlist" placeholder="Email address" />
          </div>
        </section>
      ) : null}
      ...
      <footer className="bb-footer">
        <div className="bb-shell bb-shell--wide">
          <div className="bb-footer-grid">
              ...
              <p className="bb-footer-tag">{BUBBA_BRAND.tagline}</p>
