    ...
    <section className="launch-step launch-step--hero">
      ...
      <div className="launch-step-inner launch-step-inner--hero">
        <div className="hero-copy">
          ...
          <h1 className="hero-title font-canela onboarding-heading">
            {titleLines.map((line, i) => (
              <span key={line.text} className={line.strong ? "hero-title-strong" : undefined}>
                {line.text}
        ...
        <div className="hero-art">
          <Image src="/images/onboarding/beach-invitation.png" alt="" width={940} height={953} priority />
        </div>
