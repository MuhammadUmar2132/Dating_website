          ...
          <div className="right-panel right-panel--program">
            <div className="right-form-wrap right-form-wrap--program">
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                {/* Waitlist members have no password — this is the URL they
                    guess first, so send them to the magic-link form instead of
                    leaving them at a field they can never satisfy. */}
                <p className="login-alt-route">
                  On the waitlist, not an ambassador?{" "}
                  <Link href="/auth/login">Get a login link by email</Link>
                </p>
              </form>
            </div>
          </div>
