      ...
      {showEmpty ? (
        ...
        <>
          <div className={loading ? "opacity-60 transition-opacity" : "transition-opacity"}>
            {/* The horizontal scrollbar stays visible: these tables are wider than the
                viewport on smaller screens, and hiding it left the last column
                (row actions) unreachable with no hint that it was there. */}
