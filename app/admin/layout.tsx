...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfbf8] font-sans text-black antialiased">
      <header className="w-full bg-[#fcfbf8] z-40 border-b border-neutral-200/40 sticky top-0">
      ...
      <div className="flex-grow w-full px-4 sm:px-6 md:px-12 flex flex-col md:flex-row gap-6 md:gap-8 py-6 md:py-8">
        {/* The aside keeps stretching so its divider still runs the full
            height; the nav inside it is what sticks, so every section stays
            reachable while a long table scrolls past. */}
        <aside className="hidden md:flex flex-col w-52 shrink-0 border-r border-neutral-300/40 pr-6">
          <div className="sticky top-[99px] max-h-[calc(100vh-115px)] overflow-y-auto no-scrollbar">
