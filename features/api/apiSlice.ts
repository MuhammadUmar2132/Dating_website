...
export const apiSlice = createApi({
  ...
  tagTypes: ["Me", "WaitlistStatus", "WaitlistDashboard", "Leaderboard", "AmbassadorDashboard", "AmbassadorNetwork", "AmbassadorLeaderboard", "AmbassadorCalendar", "Schools", "SchoolRanking", "Markets", "RewardProgress", "PointsHistory", "Products", "Categories", "TodayPrompt", "PromptResponses", "ResponseComments", "PromptsArchive", "ForumPosts", "ForumPost"],
  endpoints: (builder) => ({
    ...
    getMyPointsHistory: builder.query<MyPointsHistoryResponse, { page?: number; limit?: number } | void>({
      query: (params) => ({ url: "/points/my-history", method: "GET", params: params ?? undefined }),
    ...
    submitPromptResponse: builder.mutation<SubmitPromptResponseResult, SubmitPromptResponsePayload>({
      ...
      invalidatesTags: ["PromptResponses", "TodayPrompt", "Leaderboard", "WaitlistDashboard", "RewardProgress", "PointsHistory"],
    }),
    ...
    likeResponse: builder.mutation<LikeResponseResult, LikeResponsePayload>({
      ...
      // The first like of the day credits points, so the balance, ledger and
      // standings all move with it.
      invalidatesTags: ["PromptResponses", "RewardProgress", "PointsHistory", "Leaderboard", "WaitlistDashboard"],
    }),
    ...
    commentOnResponse: builder.mutation<CommentOnResponseResult, CommentOnResponsePayload>({
      ...
      invalidatesTags: (_result, _err, { responseId }) => [
        ...
        // Commenting credits points once a day.
        "RewardProgress",
        "PointsHistory",
        "Leaderboard",
      ],
